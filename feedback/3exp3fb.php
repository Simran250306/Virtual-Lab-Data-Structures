...
<head>
    ...
    <title>Feedback - Stack Applications</title>
...
<header>
        <div id="headerContent">
            <div class="logo-container">
                ...
                <!-- Update Title -->
                <div class="logo-text">Virtual Lab | Data Structures | Stack Applications Feedback</div>
            </div>
        </div>
    </header>
    <main>
        <div class="container" id="stackFormContainer">
            <h2>Stack Applications Feedback Form</h2>
            <form id="stackFeedbackForm" onsubmit="submitStackFeedback(event); return false;">
                <fieldset class="form-section">
                    <!-- Questions adapted for stack applications -->
                    <div class="feedback-question">
                        <label class="question-text">1. How well do you understand the application of stacks in function calls (the call stack)?</label>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">2. How confident are you in using a stack to reverse a string?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">3. How clear was the concept of using a stack for palindrome checking?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">4. How well did the simulation demonstrate the practical applications of stacks?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">5. How would you rate the relevance of these stack applications to real-world programming?</label>
                        <div class="radio-options-vertical">
                            <label><input type="radio" name="q5" value="1" required> 1 - Not relevant</label><br>
                            ...
                            <label><input type="radio" name="q5" value="5"> 5 - Very relevant</label>
                        </div>
                    </div>
                </fieldset>
        ...
        function submitStackFeedback(event) {
           ...
           for (const groupName of radioGroups) {
               ...
               const promise = fetch('submit_experiment_feedback.php', {
                   ...
                   body: `experiment_identifier=exp3&question_number=${questionNumber}&feedback=${encodeURIComponent(feedbackValue)}`
               });
