...
<head>
    ...
    <title>Feedback - Circular Queue</title>
...
<header>
        <div id="headerContent">
            <div class="logo-container">
                ...
                <!-- Update Title -->
                <div class="logo-text">Virtual Lab | Data Structures | Circular Queue Feedback</div>
            </div>
        </div>
    </header>
    <main>
        <div class="container" id="stackFormContainer">
            <h2>Circular Queue Feedback Form</h2>
            <form id="stackFeedbackForm" onsubmit="submitStackFeedback(event); return false;">
                <fieldset class="form-section">
                    <div class="feedback-question">
                        <label class="question-text">1. How well do you understand the advantage of a circular queue over a linear queue?</label>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">2. How confident are you in managing the `front` and `rear` pointers in a circular queue?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">3. How clear was the use of the modulo operator for pointer wrapping?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">4. How helpful was the simulation in visualizing the "wrap-around" behavior?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">5. How would you rate your understanding of the conditions for a full vs. an empty circular queue?</label>
                        <div class="radio-options-vertical">
        ...
        function submitStackFeedback(event) {
           ...
           for (const groupName of radioGroups) {
               ...
               const promise = fetch('submit_experiment_feedback.php', {
                   ...
                   body: `experiment_identifier=circularqueue&question_number=${questionNumber}&feedback=${encodeURIComponent(feedbackValue)}`
               });
