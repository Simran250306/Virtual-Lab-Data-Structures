...
<head>
    ...
    <title>Feedback - Infix to Postfix</title>
    <link rel="stylesheet" href="fb.css">
    <style>
        /* Optional: Add styles here if not fully covered in fb.css */
        /* These styles were used in the previous example, keep them if needed */
        .form-section {
...
<header>
        <div id="headerContent">
            <div class="logo-container">
                ...
                <!-- Update Title -->
                <div class="logo-text">Virtual Lab | Data Structures | Infix to Postfix Feedback</div>
            </div>
        </div>
    </header>
    <main>
        <div class="container" id="stackFormContainer">
            <h2>Infix to Postfix Feedback Form</h2>
            <form id="stackFeedbackForm" onsubmit="submitStackFeedback(event); return false;">
                <fieldset class="form-section">
                    <div class="feedback-question">
                        <label class="question-text">1. How well do you understand the purpose of converting infix to postfix notation?</label>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">2. How confident are you in applying the shunting-yard algorithm to perform the conversion?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">3. How clear were the rules for handling operators with different precedence levels?</label>
                        <div class="radio-options-vertical">
                            <label><input type="radio" name="q3" value="1" required> 1 - Not clear at all</label><br>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">4. How well did the simulation help you visualize the process of conversion?</label>
                        <div class="radio-options-vertical">
                            <label><input type="radio" name="q4" value="1" required> 1 - Not at all</label><br>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">5. How would you rate the overall difficulty of this experiment?</label>
                        <div class="radio-options-vertical">
                            <label><input type="radio" name="q5" value="1" required> 1 - Very Easy</label><br>
                            ...
                            <label><input type="radio" name="q5" value="5"> 5 - Very Difficult</label>
                        </div>
                    </div>
                </fieldset>
        ...
        function submitStackFeedback(event) {
           ...
           for (const groupName of radioGroups) {
               ...
               const promise = fetch('submit_experiment_feedback.php', {
                   ...
                   body: `experiment_identifier=intopostfix&question_number=${questionNumber}&feedback=${encodeURIComponent(feedbackValue)}`
               });
