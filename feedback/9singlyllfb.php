...
<head>
    ...
    <title>Feedback - Singly Linked List</title>
...
<header>
        <div id="headerContent">
            <div class="logo-container">
                ...
                <!-- Update Title -->
                <div class="logo-text">Virtual Lab | Data Structures | Singly Linked List Feedback</div>
            </div>
        </div>
    </header>
    <main>
        <div class="container" id="stackFormContainer">
            <h2>Singly Linked List Feedback Form</h2>
            <form id="stackFeedbackForm" onsubmit="submitStackFeedback(event); return false;">
                <fieldset class="form-section">
                    <div class="feedback-question">
                        <label class="question-text">1. How well do you understand the concept of nodes and pointers in a singly linked list?</label>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">2. How confident are you in performing insertion operations (at the beginning, end, and a specific position)?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">3. How confident are you in performing deletion operations (from the beginning, end, and a specific position)?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">4. How helpful was the simulation in visualizing the process of traversing the linked list?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">5. How would you rate your ability to solve problems involving singly linked lists after this experiment?</label>
                        <div class="radio-options-vertical">
        ...
        function submitStackFeedback(event) {
           ...
           for (const groupName of radioGroups) {
               ...
               const promise = fetch('submit_experiment_feedback.php', {
                   ...
                   body: `experiment_identifier=singlylinkedlist&question_number=${questionNumber}&feedback=${encodeURIComponent(feedbackValue)}`
               });
