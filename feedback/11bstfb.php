...
<head>
    ...
    <title>Feedback - Binary Search Tree</title>
...
<header>
        <div id="headerContent">
            <div class="logo-container">
                ...
                <!-- Update Title -->
                <div class="logo-text">Virtual Lab | Data Structures | Binary Search Tree Feedback</div>
            </div>
        </div>
    </header>
    <main>
        <div class="container" id="stackFormContainer">
            <h2>Binary Search Tree Feedback Form</h2>
            <form id="stackFeedbackForm" onsubmit="submitStackFeedback(event); return false;">
                <fieldset class="form-section">
                    <div class="feedback-question">
                        <label class="question-text">1. How well do you understand the properties of a Binary Search Tree (BST)?</label>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">2. How confident are you in performing an insertion operation in a BST?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">3. How confident are you in performing a deletion operation in a BST (handling all cases)?</label>
                        <div class="radio-options-vertical">
                            <label><input type="radio" name="q3" value="1" required> 1 - Not confident</label><br>
                            ...
                            <label><input type="radio" name="q3" value="5"> 5 - Very confident</label>
                        </div>
                    </div>
                    <div class="feedback-question">
                        <label class="question-text">4. How clear are the concepts of in-order, pre-order, and post-order traversals?</label>
                        <div class="radio-options-vertical">
                            <label><input type="radio" name="q4" value="1" required> 1 - Not clear</label><br>
                            ...
                            <label><input type="radio" name="q4" value="5"> 5 - Very clear</label>
                        </div>
                    </div>
                    <div class="feedback-question">
                        <label class="question-text">5. How would you rate the simulation's effectiveness in helping you understand BST operations?</label>
                        <div class="radio-options-vertical">
        ...
        function submitStackFeedback(event) {
           ...
           for (const groupName of radioGroups) {
               ...
               const promise = fetch('submit_experiment_feedback.php', {
                   ...
                   body: `experiment_identifier=binarysearchtree&question_number=${questionNumber}&feedback=${encodeURIComponent(feedbackValue)}`
               });
