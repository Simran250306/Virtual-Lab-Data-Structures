...
<head>
    ...
    <title>Feedback - Parenthesis Checker</title>
...
<header>
        <div id="headerContent">
            <div class="logo-container">
                ...
                <!-- Update Title -->
                <div class="logo-text">Virtual Lab | Data Structures | Parenthesis Checker Feedback</div>
            </div>
        </div>
    </header>
    <main>
        <div class="container" id="stackFormContainer">
            <h2>Parenthesis Checker Feedback Form</h2>
            <form id="stackFeedbackForm" onsubmit="submitStackFeedback(event); return false;">
                <fieldset class="form-section">
                    <div class="feedback-question">
                        <label class="question-text">1. How well do you understand the logic behind using a stack for checking balanced parentheses?</label>
                    ...
                    <div class="feedback-question">
                        <label class="question-text">2. How confident are you in identifying the conditions for balanced vs. unbalanced parentheses?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">3. How clear was the simulation in showing how the stack changes with each character?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">4. How well did you understand the importance of checking for an empty stack at the end?</label>
                        <div class="radio-options-vertical">
                    ...
                    <div class="feedback-question">
                        <label class="question-text">5. How would you rate your ability to implement a parenthesis checker after this experiment?</label>
                        <div class="radio-options-vertical">
        ...
        function submitStackFeedback(event) {
           ...
           for (const groupName of radioGroups) {
               ...
               const promise = fetch('submit_experiment_feedback.php', {
                   ...
                   body: `experiment_identifier=parenthesis&question_number=${questionNumber}&feedback=${encodeURIComponent(feedbackValue)}`
               });
