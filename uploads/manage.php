...
if (isset($_GET['delete'])) {
    ...
    // Fetch file path
    $stmt = $conn->prepare('SELECT path FROM pdfs WHERE id = ?');
    ...
    echo "<p style='color:red;'>PDF deleted successfully.</p>";
}
?>
...
<body>
    ...
    <aside id="sidebar">
        <ul>
            ...
            <li><a href="../login/faculty/general_feedback_results.php">Results</a></li>
